...
namespace Torsion {
  ...
  TorsionDialog::TorsionDialog(QWidget *parent, Qt::WindowFlags f ) :
    QDialog( parent, f )
  {
    ui.setupUi(this);
  ...
  void TorsionDialog::refresh(Avogadro::Molecule *mol)
  {
    ui.plot->resetPlot();
  ...
  void TorsionDialog::updateConformer(PlotPoint *p)
  {
